...
namespace Bookly.DataAccess.Migrations
{
    ...
    [Migration("20230918070248_addShoppingCartToDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookly.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bookly.Models.AplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Bookly.Models.ShoppingCart", b =>
                {
                    b.HasOne("Bookly.Models.AplicationUser", "AplicationUser")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Bookly.Models.Product", "Product")
                        .WithMany()
